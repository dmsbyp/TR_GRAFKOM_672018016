...
void kubah (void)
{
    ...
    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-80.0, 80.0, -1.0);
    glVertex3f(-80.0, 45.0, -1.0);
    glVertex3f(-100.0, 45.0, -1.0);
    glVertex3f(-100.0, 80.0, -1.0);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-80.0, 45.0, -1.0);
    glVertex3f(-80.0, 40.0, -1.0);
    glVertex3f(-87.0, 40.0, -1.0);
    glVertex3f(-94.0, 45.0, -1.0);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-80.0, 40.0, -1.0);
    glVertex3f(-87.0, 40.0, -1.0);
    glVertex3f(-87.0, 0.0, -1.0);
    glVertex3f(-80.0, 0.0, -1.0);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-120.0, 45.0, -1.0);
    glVertex3f(-120.0, 40.0, -1.0);
    glVertex3f(-114.0, 40.0, -1.0);
    glVertex3f(-107.0, 45.0, -1.0);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-120.0, 40.0, -1.0);
    glVertex3f(-114.0, 40.0, -1.0);
    glVertex3f(-114.0, 00.0, -1.0);
    glVertex3f(-120.0, 0.0, -1.0);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(1.0, 0.5, 0.4);
    glVertex3f(-120.0, 80.0, -1.0);
    glVertex3f(-120.0, 45.0, -1.0);
    glVertex3f(-100.0, 45.0, -1.0);
    glVertex3f(-100.0, 80.0, -1.0);
    glEnd();
...
void hotel(void)
{
    ...
    glVertex3f(615, 50, -80);
    glVertex3f(585, 50, -80);
    glVertex3f(570, 50, -60);
    glVertex3f(570, 50, -30);
    glEnd();
...
void kompor (void)
{
    glBegin(GL_QUADS);
    glColor3f(0,0,0.5);
    glVertex3f(-290, 10, -123);
    glVertex3f(-290, 10, -132);
    ...
    glBegin(GL_QUADS);
    glColor3f(0,0,0.5);
    glVertex3f(-285, 10, -123);
    glVertex3f(-285, 10, -132);
    ...
    glBegin(GL_QUADS);
    glColor3f(0,0,0);
    glVertex3f(-286, 10, -124);
    glVertex3f(-286, 10, -127);
    glVertex3f(-289, 10, -127);
    glVertex3f(-289, 10, -124);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0,0,0);
    glVertex3f(-286, 10, -128);
    glVertex3f(-286, 10, -131);
    glVertex3f(-289, 10, -131);
    glVertex3f(-289, 10, -128);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(1,0.5,0);
    glVertex3f(-287, 10, -125);
    glVertex3f(-287, 10, -126);
    glVertex3f(-289, 10, -126);
    glVertex3f(-289, 10, -125);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(1,0.5,0);
    glVertex3f(-287, 10, -129);
    glVertex3f(-287, 10, -130);
    glVertex3f(-289, 10, -130);
    glVertex3f(-289, 10, -129);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(1,1,1);
    glVertex3f(-285, 8, -129);
    glVertex3f(-285, 8, -130);
    glVertex3f(-285, 6, -130);
    glVertex3f(-285, 6, -129);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(1,1,1);
    glVertex3f(-285, 8, -125);
    glVertex3f(-285, 8, -126);
    glVertex3f(-285, 6, -126);
    glVertex3f(-285, 6, -125);
    glEnd();
}
...
void mejaatas(void)
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-340,15,-100);
    glVertex3f(-300,15,-100);
    glVertex3f(-300,13,-100);
    glVertex3f(-340,13,-100);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-340,15,-130);
    glVertex3f(-300,15,-130);
    glVertex3f(-300,13,-130);
    glVertex3f(-340,13,-130);
    glEnd();
...
void kakimeja1(void)
{
    ...
    glColor3f(0.5,0,0);
    glVertex3f(-300,13,-100);
    glVertex3f(-302,13,-100);
    glVertex3f(-302,0,-100);
    glVertex3f(-300,0,-100);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-300,13,-102);
    glVertex3f(-302,13,-102);
    glVertex3f(-302,0,-102);
    glVertex3f(-300,0,-102);
    glEnd();
...
void kakimeja2(void)
{
    ...
    glColor3f(0.5,0,0);
    glVertex3f(-340,13,-100);
    glVertex3f(-338,13,-100);
    glVertex3f(-338,0,-100);
    glVertex3f(-340,0,-100);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-340,13,-102);
    glVertex3f(-338,13,-102);
    glVertex3f(-338,0,-102);
    glVertex3f(-340,0,-102);
    glEnd();
...
kakimeja3(void)
{
    ...
    glColor3f(0.5,0,0);
    glVertex3f(-300,13,-130);
    glVertex3f(-302,13,-130);
    glVertex3f(-302,0,-130);
    glVertex3f(-300,0,-130);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-300,13,-128);
    glVertex3f(-302,13,-128);
    glVertex3f(-302,0,-128);
    glVertex3f(-300,0,-128);
    glEnd();
...
kakimeja4(void)
{
    ...
    glColor3f(0.5,0,0);
    glVertex3f(-340,13,-130);
    glVertex3f(-338,13,-130);
    glVertex3f(-338,0,-130);
    glVertex3f(-340,0,-130);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-340,13,-128);
    glVertex3f(-338,13,-128);
    glVertex3f(-338,0,-128);
    glVertex3f(-340,0,-128);
    glEnd();
...
void kakikursi4()
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-373,25,-110);
    glVertex3f(-375,25,-110);
    glVertex3f(-375,0,-110);
    glVertex3f(-373,0,-110);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-373,25,-112);
    glVertex3f(-375,25,-112);
    glVertex3f(-375,0,-112);
    glVertex3f(-373,0,-112);
    glEnd();
...
void kakikursi3()
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-373,25,-120);
    glVertex3f(-375,25,-120);
    glVertex3f(-375,0,-120);
    glVertex3f(-373,0,-120);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-373,25,-118);
    glVertex3f(-375,25,-118);
    glVertex3f(-375,0,-118);
    glVertex3f(-373,0,-118);
    glEnd();
...
void kakikursi2()
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-353,13,-110);
    glVertex3f(-350,13,-110);
    glVertex3f(-350,0,-110);
    glVertex3f(-353,0,-110);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-353,13,-112);
    glVertex3f(-350,13,-112);
    glVertex3f(-350,0,-112);
    glVertex3f(-353,0,-112);
    glEnd();
...
void kakikursi1()
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-353,13,-120);
    glVertex3f(-350,13,-120);
    glVertex3f(-350,0,-120);
    glVertex3f(-353,0,-120);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-353,13,-118);
    glVertex3f(-350,13,-118);
    glVertex3f(-350,0,-118);
    glVertex3f(-353,0,-118);
    glEnd();
...
void kursi (void)
{
    ...
    glColor3f(0.5,0,0);
    glVertex3f(-350,13,-110);
    glVertex3f(-375,13,-110);
    glVertex3f(-375,10,-110);
    glVertex3f(-350,10,-110);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-350,13,-120);
    glVertex3f(-375,13,-120);
    glVertex3f(-375,10,-120);
    glVertex3f(-350,10,-120);
    glEnd();
...
void duduk (void)
{
    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-375,15,-110);
    glVertex3f(-375,15,-120);
    glVertex3f(-375,20,-120);
    glVertex3f(-375,20,-110);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3f(0.5,0,0);
    glVertex3f(-373,15,-110);
    glVertex3f(-373,15,-120);
    glVertex3f(-373,20,-120);
    glVertex3f(-373,20,-110);
    glEnd();
...
void tampilan(void){
 ...
 glPushMatrix();
		...
		if ((b / 180) % 2 == 1) {
			...
			lingkaran(25,100,-650,0);
			glColor3f(1.0, 1.0, 0.0);
			glClearColor(0.5f, 1.0f, 1.0f, 0);
		}
	glPopMatrix();
